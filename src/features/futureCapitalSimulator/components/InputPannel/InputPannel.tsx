import { Card, Divider, Flex, Form, InputNumber, Radio, Tooltip } from "antd";
        ...
        <Flex vertical>
          ...
          >
            <Radio.Group
              ...
              onChange={(val) =>
                handleOnChange("contributionFrequencyType", val.target.value)
              }
              style={{ width: "100%" }}
          ...
          <Form.Item
            ...
            help="Inserisci la quota di versamenti periodici."
          >
            <InputNumber
              addonBefore="€"
              type="number"
        ...
        >
          <Flex vertical gap="8px">
            ...
            <InputNumber
              ...
              placeholder="0"
              value={
                isCustomVestmentHorizon ? inputData.vestmentHorizon : undefined
              }
